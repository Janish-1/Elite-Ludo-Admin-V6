...
<div class="main-menu menu-fixed {{ $websettings->sideskin_mode }} menu-accordion menu-shadow"
    ...
    <div class="main-menu-content">
        ...
        <ul class="menu-content">
            ...
            <li class="nav-item"><a class="d-flex align-items-center" href="{{ url('/') }}/admin/tournament"><i
                        class="las la-dice-five"></i><span class="menu-title text-truncate" data-i18n="Invoice">Tournament</span></a>
            </li>
