            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                        <!-- form 1 -->
                        <form class="general_setting" method="post" action="{{ route('update.Ad.imagea') }}" enctype="multipart/form-data" data-parsley-validate autocomplete="off">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general-2" aria-labelledby="account-pill-general-2" aria-expanded="true">
                        <!-- form 2 -->
                        <form class="general_setting" method="post" action="{{ route('update.Ad.imageb') }}" enctype="multipart/form-data" data-parsley-validate autocomplete="off">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex align-items-center mb-2">
